...
import { MutationHeader } from '~/components/Mutation';
...
export const Page = () => {
  ...
  useEffect(() => {
    if (actionData) {
      if (actionData.hasError) {
        ...
        navigate(BrandingFullFeaturesBaseUrl);
      }
    }
  ...
  return (
    <div className="flex h-full flex-col">
      <MutationHeader title={t('branding:save')} onBack={() => navigate(BrandingFullFeaturesBaseUrl)} />
      ...
      <MutationFooter
        ...
        onCancel={() => navigate(BrandingFullFeaturesBaseUrl)}
      />
